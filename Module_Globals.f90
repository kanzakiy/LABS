   ...
   logical, save :: Long_run,  O2lim_on, calc_perm, Perm_Rec, Form_Rec , calc_form
   ...
   integer(kind=4), parameter :: File_temp = 950, File_flux = 230, File_Log = 340, File_Perm = 220, File_form = 210
